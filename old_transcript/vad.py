...
SPEECH_WINDOW = getattr(settings, 'SPEECH_WINDOW', 0.5)
...
class VoiceActivityDetector():
    ...
    def __init__(self, wave_input_filename):
        ...
        self.sample_window = SAMPLE_WINDOW #20ms : Size of the window , def : 0.02
        self.sample_overlap = SAMPLE_OVERLAP #10ms , def : 0.01
        self.speech_window = SPEECH_WINDOW #half a second , def : 0.5
        self.speech_energy_threshold = SPEECH_ENERGY_THRESHOLD #60% of energy in voice band , def : 0.6
        self.speech_start_band = SPEECH_START_BAND #300 , def : 300
        self.speech_end_band = SPEECH_END_BAND #3000 , def : 3000
